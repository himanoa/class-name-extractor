module Test.ClassNameExtractor.Execute where

import Prelude

import ClassNameExtractor.Data.Output (FileBody(..), Namespace(..), coerceFileBody)
import ClassNameExtractor.Execute (execute)
import ClassNameExtractor.FS (class MonadFS)
import ClassNameExtractor.RIO (Env)
