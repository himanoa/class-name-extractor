module ClassNameExtractor.Execute where

import Prelude

import ClassNameExtractor.CssParser (extractClassNames)
...
import ClassNameExtractor.FS (class MonadFS, readFile, writeFile)
